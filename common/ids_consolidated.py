"""
ID Generation Service interface and implementation.
...
class ConcreteIDService(IDService):
    """
    Concrete implementation of IDService interface.
    
    Production implementation providing all required ID generation operations
    with multiple format support and deterministic testing capability.
    """
...
# Global singleton instance - this is the canonical IDService for the application
id_service = ConcreteIDService()

# Export the concrete instance as the service interface - this allows 
# "from common.ids import id_service" to get the working implementation
__all__ = ['IDService', 'ConcreteIDService', 'IDFormat', 'id_service']